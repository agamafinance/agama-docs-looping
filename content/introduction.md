...
Behind those three sits the [Allocation Engine](/stellar/contracts#allocation-engine), which routes Vault capital into the credit vaults and enforces the concentration caps and the reserve floor on every call, all four measured in basis points of net assets.
