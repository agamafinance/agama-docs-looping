...
3. **sagUSD.** Stake agUSD to receive sagUSD, a yield-bearing token. Its value accrues over time as the underlying pools collect yield from private credit and bonds — no separate claim step required.
...
| **Upgrade path** | — | Stake into sagUSD for yield-bearing exposure |
