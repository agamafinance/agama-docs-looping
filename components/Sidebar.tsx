  ...
  return (
    ...
    >
      ...
      <kbd
        ...
        style={{
          background: 'rgba(230, 254, 244, 0.06)',
          color: '#9CA3AF',
          border: '1px solid rgba(230, 254, 244, 0.08)',
          fontFamily:
  ...
  return (
    <div>
      <button
        ...
        className="w-full flex items-center gap-1.5 px-2 py-[6px] text-base text-[#9CA3AF] hover:text-[#E6FEF4] transition-colors duration-200 text-left"
        aria-expanded={open}
      >
  ...
  return (
    <div className="mb-6 last:mb-2">
      <div className="flex items-center gap-2.5 px-2 mb-2">
        ...
        <h4 className="text-base font-medium select-none text-[#E6FEF4]">{section.title}</h4>
      </div>
    ...
    <div className="px-6 py-4" style={{ borderTop: '1px solid rgba(230, 254, 244, 0.06)' }}>
      <div className="flex items-center gap-3">
        ...
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="ml-auto inline-flex items-center gap-1 text-base text-[#9CA3AF] hover:text-[#E6FEF4] transition-colors"
        >
          Agama
  ...
  return (
    <>
      ...
      <aside
        ...
        style={{
          background: '#0D2B28',
          borderRight: '1px solid rgba(230, 254, 244, 0.08)',
        }}
      >
        <div
          className="px-6 pt-[18px] pb-4"
          style={{ borderBottom: '1px solid rgba(230, 254, 244, 0.06)' }}
        >
