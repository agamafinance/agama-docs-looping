...
function coverShortfall(uint256 usdrAmount)
...
```
reserveCoverageRatio = ReserveFund.totalAssetValueUSDr() / LendingPool.totalBorrowed()
```
...
!!! warning
    ...
    **Design Review #12**: the ReserveFund opens at zero balance at mainnet. For the first N months, the coverage ratio will be thin. We recommend founders seed 100k USDr at launch to maintain ≥ 1% ratio from day 1.
