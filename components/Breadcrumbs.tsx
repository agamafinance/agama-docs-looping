...
export function Breadcrumbs() {
  ...
  return (
    <div className="flex flex-wrap items-center gap-x-2 gap-y-1 text-base mb-6">
      <Link
        href="/docs"
        className="font-mono text-[#9BA9B6] hover:text-[#26E994] transition-colors py-1 px-1 -mx-1 inline-block break-words"
      >
        Documentation
      </Link>
      <div className="flex items-center">
        ...
        />
        <span className="font-mono text-[#26E994] break-words">{slug}</span>
      </div>
    </div>
  );
}
